...
Vue.component('agents-view', {
  template: `
    <div>
      ...
      <modal v-if="isModalOpen" :title="isEditing ? 'Edit Agent' : 'Create New Agent'" @close="closeModal">
  ...
  methods: {
    ...
    async deleteAgent(agent) {
      if (confirm(`Are you sure you want to delete the agent "${agent.name}"?`)) {
        ...
        // TODO: Also remove this agentId from any agentSets
        await this.fetchAgents();
      }
    }
  }
