...
import { useVisualization, useAddSupplementalConnection } from '@/db/useVisualization.ts'
...
<template>
  ...
  <div v-else-if="visualization">
    ...
    <Graph :structure="visualization.structure" @add-connection="addSupplementalConnection" />
  </div>
</template>
